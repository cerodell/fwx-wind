...
decimal_end_deciseconds = int(int(file_date[-2:])/4) * 60 * 60 / 0.1     # decimal end hour
decimal_start_hour = (decimal_end_deciseconds - len(sonic_df)) / 60 / 60 * 0.1 # decimal start hour
